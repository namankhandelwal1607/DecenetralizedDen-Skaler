...
const Stock = () => {
  ...
  useEffect(() => {
    const connectWallet = async () => {
      const contractAddressAssetManager = "0x1d4E5c1038900C9b8a19d46dcc9Bbd6cFeE8AFEB";
      const contractABIAssetManager = abiAssetManager.abi;
      const contractAddressBet = "0xFFa73AAEeE475B69c11a551b07f60754c524b507";
      const contractABIBet = abiBet.abi;
      const contractAddressPriceFeed = "0x56Ff6f4A98155FB23DaFF8D8895F144B0A8539Ed";
